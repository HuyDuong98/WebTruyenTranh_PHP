...
<body>
            ...
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="lienhe.html"><i class="fas fa-phone"></i> Liên Hệ</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="tieu-de">
                <div class="name">
                    <h4>Truyện tranh hot >> <?php if(isset($_SESSION['success'])) :?>
                         <p class="text-danger"><?=$_SESSION['success'] ?></p>
                    <?php endif; unset($_SESSION['success']) ?></h4>
                ...
                <div class="col-lg-3">
                    <div class="card">
                        <div class="nd position-relative">
                            ...
                            <div class="noi-dung">
                                <a href="#">Bạn đang đọc truyện Sam Sam đến đây ăn nè! của tác giả Cố Mạn trên website truyện tranh hay.
                                    ...
                                    không lại sói, đành phải ngồi yên để cho sói vỗ béo.
                                </a>
                            </div>
                        </div>
                        <div class="card-body text-center">
                            ...
                            <div class="bt">
                                <a href="cart.php?MaTT=<?= $tt["MaTT"];?>" class="btn btn-primary ">
                                    <i class="fas fa-cart-plus"></i> Đặt</a>
                                <a href="doctruyen.html" class="btn btn-primary">
